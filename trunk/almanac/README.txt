...
To get the code.  Follow directions and copy it into your Python site-packages directory (on Mac, it is /Library/Python/2.5/site-packages/).  This is the same directory where django is installed.
